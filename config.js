const config = {
  ...
  "openHouse": {
    ...
    "bundleItems": [
      ...
      {
        "icon": "fas fa-star",
        "text": "Benefit: Completely finished Luxurious turn-key home including Finished Basement with kitchen and 2 extra bedrooms and Full Landscaping with pool and cabana with outdoor bathroom"
      },
      {
        "icon": "fas fa-check-circle",
        "text": "Benefit: New high-end finishes including Full Kitchen, Herringbone flooring, Appliances (SubZero 72"
      },
      {
        "icon": "fas fa-car",
        "text": "3-Car garage, 10 foot ceilings on main, and 9 foot ceilings in basement and 2nd floor"
      },
      {
